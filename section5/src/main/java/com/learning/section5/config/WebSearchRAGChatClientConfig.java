...
import com.learning.section5.rag.WebSearchDocumentRetriever;
...
public class WebSearchRAGChatClientConfig {
    ...
    public ChatClient chatClient(ChatClient.Builder chatClientBuilder,
        ...
        return chatClientBuilder.defaultAdvisors(List.of(loggerAdvisor, tokenUsageAdvisor, memoryAdvisor, webSearchRAGAdvisor))
                .build();
    }
}
